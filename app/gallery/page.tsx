...
const PHOTOS: GalleryPhoto[] = [
  ...
  { src: "/images/gallery-friends-night-1.png", alt: "Friends gathered at a high-top table inside Finnegan's Wake", caption: "A full table and a full room on a lively night downtown." },
  { src: "/images/gallery-friends-night-2.png", alt: "Group photo night at Finnegan's Wake", caption: "Theme-night energy, cold drinks, and everyone packed in together." },
];
  ...
  return (
    <>
      ...
      >
        ...
        <p>A familiar amber light, the patio in July, and twenty years of evenings captured in moments.</p>
      </section>
